...
curl_setopt($ch, CURLOPT_URL, "https://dvlp.bpjs-kesehatan.go.id/VClaim-rest/Rujukan/List/Peserta/$no");
...
<tbody>
  <tr>
    <th scope='row'><?=$i++?></th>
    <td><a class="badge badge-primary" href="<?= 'http://localhost/rawatInap/pendaftaran/sepbarurujukan1?norujukan='?><?= $a['noKunjungan']?>"><?= $a['noKunjungan']?></a></td>
