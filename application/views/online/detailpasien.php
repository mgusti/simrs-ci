...
<div class="row">
    <div class="col-lg-6">
        <div class="card mb-3">
            <form action="<?= base_url('online/editpasien') ?>" method="post">
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="tgl_lahir" id="tgl_lahir" value="<?= $pasien['tgl_lahir'] ?>" data-provide="datepicker" data-date-format="yyyy-mm-dd"></td>
                    </tr>
                    <tr>
...
<a href="<?= base_url(); ?>online/dataonline" class="btn btn-primary mt-3 mb-3"> KEMBALI</a>
