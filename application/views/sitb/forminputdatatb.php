<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?= base_url('sitb/inputtb') ?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <textarea name="alamat_lengkap" id="alamat_lengkap" cols="10" rows="4" class="form-control"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <label for="">ID Provinsi Pasien </label>
                        <input type="number" name="id_propinsi_pasien" id="id_propinsi_pasien" class="form-control" required>
                    </div>
                    <div class="col-lg-3">
                        <label for="">Kode Kabupaten Pasien </label>
                        <input type="number" name="kd_kabupaten_pasien" id="kd_kabupaten_pasien" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="kode_icd_x" id="kode_icd_x" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="date" name="tanggal_mulai_pengobatan" id="tanggal_mulai_pengobatan" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="date" name="tanggal_hasil_akhir_pengobatan" id="tanggal_hasil_akhir_pengobatan" class="form-control">
                    </div>
                    <div class="col-lg-4">
