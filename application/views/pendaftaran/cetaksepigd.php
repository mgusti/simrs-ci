...
<form action="<?= base_url('pendaftaran/simpansepcetak')?>" method="post">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <input type="text" class="form-control" name="dinsos" value="<?= $tes["response"]['sep']["informasi"]["Dinsos"]?>" id="dinsos" readonly>
        </div>
        <div class="col-lg-3">
            <label for="">Porlanis PRB</label>
            <input type="text" class="form-control" name="porlanisprb" value="<?= $tes["response"]['sep']["informasi"]["porlanisPRB"]?>" id="porlanisprb" readonly>
        </div>
        <div class="col-lg-3">
            <label for="">nosktm</label>
            <input type="text" class="form-control" name="nosktm" value="<?= $tes["response"]['sep']["informasi"]["noSKTM"]?>" id="nosktm" readonly>
        </div>
    </div>
    
    <button class="btn btn-info mt-3">Cetak SEP</button>
    <a href="<?= base_url('pendaftaran/sepbaru?nosep=&nokartu=')?><?= $_GET['nokartu']?>" class="btn btn-danger mt-3">Kembali</a>
</form>
</div>