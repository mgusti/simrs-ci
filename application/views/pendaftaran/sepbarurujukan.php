...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <select name="poli" id="poli1" class="form-control" readonly>
                <option value="<?= $norujukan["response"]["rujukan"]["poliRujukan"]["kode"]?>"><?= $norujukan["response"]["rujukan"]["poliRujukan"]["nama"]?></option>
            </select>
        </div>
        <div class="col-lg-3">
            <label for="">Jenis Pelayanan</label>
            <select name="jnspelayanan" id="jnspelayanan1" class="form-control" readonly>
