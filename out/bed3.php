	...
	<div align="left">
		...
		<table width='100%' bgcolor='FFFFFF' border='0' align='center' cellpadding='0' cellspacing='0'>
			<tr class='head4'>
				<td width='40%'>
					<div align='center'>
						<font size='5'><b>NAMA KAMAR</b></font>
					</div>
				</td>
				<td width='20%'>
					<div align='center'>
			...
			while ($data = mysqli_fetch_array($hasil)) {
				echo "<tr class='isi7' >
					...
					<td align='center'>
					     <font size='6' color='red' face='Tahoma'>
					      <b>";
				$data2 = mysqli_fetch_array(bukaquery("select count(kd_bangsal) from kamar where kamar.statusdata='0' and kd_bangsal='" . $data['kd_bangsal'] . "'"));
				echo $data2[0];
				echo "</b>
					      </font>
					</td>
				...
				echo "</b>
					...
					<td align='center'>
					      ...
					      <b>";
				$data2 = mysqli_fetch_array(bukaquery("select count(kd_bangsal) from kamar where kamar.statusdata='0' 	and kd_bangsal='" . $data['kd_bangsal'] . "' and status='KOSONG'"));
				echo $data2[0];
				echo "</b>
					     </font>
					</td>
