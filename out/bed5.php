...
<body class="bg">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $data['nm_bangsal'];?></td>
                            <?php $data2 = mysqli_fetch_array(bukaquery("select count(kd_bangsal) from kamar where kamar.statusdata='0' and kd_bangsal='" . $data['kd_bangsal'] . "'"));?>
                        <td><?php echo $data2[0];?></td>
                            <?php $data2 = mysqli_fetch_array(bukaquery("select count(kd_bangsal) from kamar where kamar.statusdata='1' and kd_bangsal='" . $data['kd_bangsal'] . "' and status='ISI'")); ?>
                        <td><?php echo $data2[0];?></td>
                            <?php $data2= mysqli_fetch_array(bukaquery("select count(kd_bangsal) from kamar where kamar.statusdata='0' 	and kd_bangsal='" . $data['kd_bangsal'] . "' and status='KOSONG'"));?>
                        <td><?php echo $data2[0];?></td>
                    </tr>
                    <?php } ?>
                </tbody>
    ...
    <script type="text/javascript">
        var auto_refresh = setInterval(function() {
            $('#data').load('data_jadwal_kamar.php').fadeIn("slow");
        }, 5000);
    </script>
